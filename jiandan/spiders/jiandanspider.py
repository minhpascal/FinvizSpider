...
class jiandanSpider(scrapy.Spider):
    ...
    start_urls = ["http://www.finviz.com/screener.ashx?v=111&f=exch_nyse,idx_sp500,sh_avgvol_o2000,sh_price_10to50&o=-changeopen"]
    ...
    def parse(self,response):
        ...
        for content in content_list:
            ...
            item['Company'] = content.xpath('td[3]/a/text()').extract()
            item['Sector'] = content.xpath('td[4]/a/text()').extract()
